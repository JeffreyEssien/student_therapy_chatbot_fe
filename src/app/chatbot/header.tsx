  ...
  return (
    <header className="relative z-30 flex items-center justify-between border-b border-ink/8 bg-paper/80 px-6 py-4 backdrop-blur-xl">
      ...
      <div className="relative">
        ...
        {menuOpen && (
          <div className="reveal absolute right-0 top-10 z-10 min-w-[200px] border border-ink/10 bg-paper shadow-[0_20px_50px_-20px_rgba(0,0,0,0.25)]">
            ...
            <button
              onClick={onSignOut}
              className="flex w-full items-center justify-between px-4 py-3 text-left font-mono text-eyebrow uppercase text-ink/80 transition-colors duration-300 hover:bg-emerald-deep hover:text-paper"
            >
              <span>Sign out</span>
